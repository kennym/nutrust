    ...
    return(
        <div className="w-full flex items-center flex-col">
            <div className="w-full font-normal flex justify-center items-center flex flex-col pb-[28rem] relative overflow-hidden max-w-[1400px] ">
                <h1 className="mt-28 text-7xl max-w-[800px] text-center text-white">High returns, with the best investors</h1>
            ...
            <div className="w-full font-normal flex justify-center flex relative overflow-hidden max-w-[1400px] py-40 px-14">
                <div className="w-1/2 flex flex-col">
                    <h2 className="text-7xl text-white leading-[1.1]">Discover the best yields of the market</h2>
                    <p className="mt-4 w-5/6 leading-6 text-sm text-pro-100 text-pro-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum</p>
                </div>
                <div className="w-1/2 flex items-center justify-end">
                    <div className="w-96 border border-gray-500 rounded-md p-5 flex flex-col">
            ...
            <div className="w-full flex-col font-normal flex pb-[46rem] items-center flex relative overflow-hidden max-w-[1400px] pt-12 px-14">
                <h2 className="text-7xl text-center text-white w-[800px]">Be a trader and earn profits no risk</h2>
                <Link to="/" className="text-green-500 flex items-center">Be a Trader <img src={arrowright} className="brand ml-2 w-5"/></Link>
                <img src={bg2} className="absolute -bottom-[14rem]  w-[80%] rotate-[10deg] " />
            </div>
        </div>
    )
}
