                    ...
                    <div className="top-14 left-0 min-w-[250px] w-[20%] border border-r-gray-800 border-transparent h-[calc(100vh_-_3.5rem)] flex flex-col justify-between">
                                ...
                                <div className="absolute left-0 w-96 flex flex-col px-4 pt-4 bg-black z-20 border border-gray-500">
                                    <p>Your accounts</p>
                                    {
                                        plans.map((plan:any, key) => {
                                            return (
                                                <div key={key} id={plan.id} onClick={() => setSelected__(plan.id)} className="flex items-center justify-between py-4 border border-transparent border-b-gray-800 hover:border-b-green-500 cursor-pointer">
                                                    <p className="text-sm">Star Trader (${plan.plan.account__balance})</p>
                        ...
                        <div className="w-full my-4 shrink-0">
                            <div className="w-full flex items-center px-4 text-[14px] ">
                                <button className="w-1/2 bg-green-500 font-semibold text-black py-2.5">Long</button>
                                <button className="w-1/2 bg-white font-semibold text-black py-2.5">Short</button>
                            </div>

                            <p className="text-sm flex items-center justify-between px-4 mt-4">Balance ≈ <span>10,000.00</span></p>
                            <p className="text-sm flex items-center justify-between px-4 mt-2">Order Type <span>Market Order</span></p>

                            <div className="w-full flex relative items-center px-4 mt-4">
                                <input type="text" placeholder="0.00" className="placeholder:text-pro-100 w-full bg-gray-800 h-10 border border-gray-700 px-4" />
                                <div className="absolute w-20 h-full border border-gray-700 bg-gray-800 flex items-center justify-center right-4">USDT</div>
                            </div>
                            ...
                            <p className="text-sm flex items-center justify-between px-4 mt-4">Fee ≈ <span>0.52%</span></p>
                            <p className="text-sm flex items-center justify-between px-4 mt-2">Total ≈ <span>0.0572 BTC</span></p>
                            
                            <div className="w-full px-4 mt-6 text-[14px]">
                                <button className="shrink-0 w-full bg-green-500 font-semibold text-black py-2.5">Place Order</button>
                            </div>
                        </div>
                    </div>
